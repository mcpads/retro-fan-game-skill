...
Select only the claims relevant to the asset component:

- coverage: every required route, state, variant, and host surface is mapped,
- coherence: related representations preserve approved identity and state,
- source conformance: declared source meanings survive intentional adaptation,
- presentation: approved visual or audio intent is met,
