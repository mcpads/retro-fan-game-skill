...
Assign roles per claim or unit, not once for the whole project:

| Role | Authority |
| --- | --- |
| Narrative authority | Determines the source events, causal order, or meaning inside its declared scope |
| Canon-constraint authority | Constrains new work without requiring source-scene coverage |
| Comparison witness | Supports differences, omissions, lineage, or uncertainty but cannot overwrite an authority |
| Inspiration only | May influence creative work but cannot support a source-fidelity claim |
...
- preservation or transposition emphasizes source coverage, causal order, and
  semantic invariants,
- divergence emphasizes conformance before the divergence point and coherent
  consequences after it,
- continuation emphasizes agreement between source result state and new
  starting state,
- restoration distinguishes supported reconstruction from invention,
- synthesis emphasizes scoped authority, conflict decisions, and the meaning
  of each merge,
- canon-constrained original work emphasizes constraint conformance rather
  than scene coverage.
