...
Start from the intended playable, the play segment in progress, and the current
unresolved decision. Choose
...
| Which segment comes next, and which source meanings and host surfaces constrain it? | Defined play segment with bounded components and dependencies | [Creative Overlay](creative-overlay.md) |
...
| Does the person accept how it looks, sounds, or reads? | Judgeable candidate and recorded decision | [Creative Review](creative-review.md) |
...
it is easy to automate. Complete connection with placeholders before polishing
presentation when the route's progression risk is still unknown.
